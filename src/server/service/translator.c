...
static const translation_rule_t g_rules[] = {
    ...
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_KEY,    ACTION_GET_PRIVATE_KEY_ACCESS,    "auto",       "SKF_VerifyPIN"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_KEY,    ACTION_RELEASE_PRIVATE_KEY_ACCESS,"auto",       "SKF_ClearSecureState"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_KEY,    ACTION_GENERATE_KEY_PAIR,         "sm2",        "SKF_GenECCKeyPair"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_KEY,    ACTION_GENERATE_KEY_PAIR,         "rsa",        "SKF_GenRSAKeyPair"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_KEY,    ACTION_GENERATE_KEY_PAIR,         "kyber768",   "SKF_GenerateKeyPairKyber"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_KEY,    ACTION_GENERATE_KEY_PAIR,         "mlkem768",   "SKF_GenerateKeyPairKyber"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_KEY,    ACTION_GENERATE_KEY_PAIR,         "dilithium3", "SKF_GenerateKeyPair_Dilithium"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_KEY,    ACTION_EXPORT_PUBLIC_KEY,         "sm2",        "SKF_ExportPublicKey"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_KEY,    ACTION_EXPORT_PUBLIC_KEY,         "rsa",        "SKF_ExportPublicKey"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_KEY,    ACTION_IMPORT_KEY,                "auto",       "SKF_SetSymmKey"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_KEY,    ACTION_DESTROY_KEY,               "auto",       "SKF_DeleteContainer"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_ASYM,   ACTION_SIGN,                      "sm2",        "SKF_ECCSignData"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_ASYM,   ACTION_VERIFY,                    "sm2",        "SKF_ECCVerify"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_ASYM,   ACTION_ENCRYPT,                   "sm2",        "SKF_ExtECCEncrypt"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_ASYM,   ACTION_DECRYPT,                   "sm2",        "SKF_ECCDecrypt"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_ASYM,   ACTION_SIGN,                      "rsa",        "SKF_RSASignData"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_ASYM,   ACTION_VERIFY,                    "rsa",        "SKF_RSAVerify"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_ASYM,   ACTION_ENCRYPT,                   "rsa",        "SKF_ExtRSAPubKeyOperation"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_ASYM,   ACTION_DECRYPT,                   "rsa",        "SKF_RSADecrypt"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_SYM,    ACTION_ENCRYPT,                   "sm4-cbc",    "SKF_Encrypt"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_SYM,    ACTION_DECRYPT,                   "sm4-cbc",    "SKF_Decrypt"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_SYM,    ACTION_ENCRYPT,                   "sm4-ecb",    "SKF_Encrypt"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_SYM,    ACTION_DECRYPT,                   "sm4-ecb",    "SKF_Decrypt"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_SYM,    ACTION_MAC,                       "sm4-mac",    "SKF_Mac"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_HASH,   ACTION_HASH,                      "sm3",        "SKF_Digest"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_HASH,   ACTION_HASH,                      "sha256",     "SKF_Digest"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_FILE,   ACTION_CREATE_FILE,               "auto",       "SKF_CreateFile"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_FILE,   ACTION_READ_FILE,                 "auto",       "SKF_ReadFile"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_FILE,   ACTION_WRITE_FILE,                "auto",       "SKF_WriteFile"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_FILE,   ACTION_DELETE_FILE,               "auto",       "SKF_DeleteFile"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_PQC,    ACTION_SIGN,                      "dilithium3", "SKF_Sign_Dilithium"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_PQC,    ACTION_VERIFY,                    "dilithium3", "SKF_Verify_Dilithium"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_PQC,    ACTION_KEM_ENCAP,                 "kyber768",   "SKF_Encap_Kyber"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_PQC,    ACTION_KEM_DECAP,                 "kyber768",   "SKF_Decap_Kyber"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_PQC,    ACTION_KEM_ENCAP,                 "mlkem768",   "SKF_Encap_Kyber"},
    {"gm3000-skf",    DEV_CLASSIC, DOMAIN_PQC,    ACTION_KEM_DECAP,                 "mlkem768",   "SKF_Decap_Kyber"},
