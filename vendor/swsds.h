...
/*抗量子算法相关数据结构*/
#define KyberPubKey_MAX_LEN			2048
#define KyberPrivKey_MAX_LEN		4096

typedef struct KyberPublicKey_st
{
	unsigned int  pk_len;
	unsigned char pk[KyberPubKey_MAX_LEN];
} KyberPublicKey;

typedef struct KyberPrivateKey_st
{
	unsigned int  sk_len;
	unsigned char sk[KyberPrivKey_MAX_LEN];
} KyberPrivateKey;

#define DilithiumPubKey_MAX_LEN			3072
#define DilithiumPrivKey_MAX_LEN		5120
typedef struct DilithiumPublicKey_st
{
	unsigned int  pk_len;
	unsigned char pk[DilithiumPubKey_MAX_LEN];
} DilithiumPublicKey;

typedef struct DilithiumPrivateKey_st
{
	unsigned int  sk_len;
	unsigned char sk[DilithiumPrivKey_MAX_LEN];
} DilithiumPrivateKey;
...
#define SGD_SHAKE128	0x00000100
#define SGD_SHAKE256	0x00000200
#define SGD_SHA3_256	0x00000400
#define SGD_SHA3_384	0x00000800
#define SGD_SHA3_512	0x00001000
...
/*抗量子算法运算函数*/
SGD_RV SDF_GenerateKeyPairKyber(SGD_HANDLE hSessionHandle, SGD_UINT32 uiSecurityLevel, SGD_UINT32 uiKeyIndex, KyberPublicKey* pucPubKey, KyberPrivateKey* pucPriKey);
SGD_RV SDF_Encap_Kyber(SGD_HANDLE hSessionHandle, SGD_UINT32 uiKeyIndex, KyberPublicKey* pucPubKey, SGD_UINT32 uiSecurityLevel, SGD_UCHAR* pucCipherData, SGD_UINT32* puiCipherDataLen, SGD_UCHAR* pucKey, SGD_UINT32* puiKeyLen);
SGD_RV SDF_Decap_Kyber(SGD_HANDLE hSessionHandle, SGD_UCHAR* pucCipherData, SGD_UINT32 uiCipherDataLen, SGD_UINT32 uiKeyIndex, KyberPrivateKey* pucPriKey, SGD_UINT32 uiSecurityLevel, SGD_UCHAR* pucKey, SGD_UINT32* puiKeyLen);
SGD_RV SDF_GenerateKeyPair_Dilithium(SGD_HANDLE hSessionHandle, SGD_UINT32 uiSecurityLevel, SGD_UINT32 uiKeyIndex, DilithiumPublicKey* pucPubKey, DilithiumPrivateKey* pucPriKey);
SGD_RV SDF_Sign_Dilithium(SGD_HANDLE hSessionHandle, SGD_UCHAR* pucData, SGD_UINT32 uiDataLength, SGD_UINT32 uiKeyIndex, DilithiumPrivateKey* pucPriKey, SGD_UCHAR* pucContext, \
	SGD_UINT32 uiContextLen, SGD_UINT32 uiHashAlgID, SGD_UINT32 uiExpectHashDataLen, SGD_UINT32 uiSecurityLevel, SGD_UINT32 uiRandomizeSigning, \
	SGD_UCHAR* pucSignature, SGD_UINT32* puiSignatureDataLength);
SGD_RV SDF_Verify_Dilithium(SGD_HANDLE hSessionHandle, SGD_UINT32 uiKeyIndex, DilithiumPublicKey* pucPubKey, SGD_UCHAR* pucContext, SGD_UINT32 uiContextLen, SGD_UINT32 uiHashAlgID,
	SGD_UINT32 uiExpectHashDataLen, SGD_UINT32 uiSecurityLevel, SGD_UCHAR* pucData, SGD_UINT32 uiDataLength, SGD_UCHAR* pucSignature, SGD_UINT32 uiSignatureDataLength);
